...
let qtdHidratacao = 0;
let qtdInfantil=0;
let numCartao=0;    //Valor inicial deve sempre ser igual ao último valor guardado no banco
...
{
    window.location.href="GerarCartao.html"
}
...
function redirRelatorioServicos()
{
